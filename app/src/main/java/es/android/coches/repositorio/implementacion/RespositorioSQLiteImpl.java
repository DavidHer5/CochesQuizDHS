...
public class RespositorioSQLiteImpl extends SQLiteOpenHelper implements Repositorio<Pregunta> {
    ...
    public RespositorioSQLiteImpl(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public RespositorioSQLiteImpl(@Nullable Context context) {
